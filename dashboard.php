            ...
            <section style="padding-left: 20px; padding-right: 20px;">
                <div class="col-sm-3">
                    <div class="card card-green">
                        ...
                        <h2 style="color: #282828; text-align: center;"><?php if(isset($total_products['products'])){echo $total_products['products'];} ?></h2>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="card card-yellow" >
                        <h3>Products Bought </h3>
                        <h2 style="color: #282828; text-align: center;"><?php if(isset($total_products['total_bought'])){echo $total_bought['total_bought'];} ?></h2>
                    </div>
                </div>
                <div class="col-sm-3 " >
                    <div class="card card-blue" >
                        <h3>Products Sold </h3>
                        <h2 style="color: #282828; text-align: center;"><?php if(isset($total_products['total_sold'])){echo $total_sold['total_sold'];} ?></h2>
                    </div>
                </div>
                <div class="col-sm-3" >
                    <div class="card card-red" >
                        <h3>Available Stock </h3>
                        <h2 style="color: #282828; text-align: center;"><?php if(isset($stock_available)){echo $stock_available;} ?></h2>
                    </div>
                </div>
            </section>
        </div>
